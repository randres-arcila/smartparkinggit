...
@Component({
  ...
  templateUrl: './barranquilla.component.html',
  styleUrls: ['./barranquilla.component.css']
})
export class BarranquillaComponent implements OnInit {
  devices: any[] = [];
  ...
  ngOnInit() {
    ...
    this.webSocketService.emit('Join','circunbarranquilla');
    ...
    const print=()=>{
      ...
      mapSprite.src = '../../../assets/Img/BarranquillaM.jpg';
      context.fillStyle = "#000";
      context.fillRect(0, 0, canvas.width, canvas.height);
      context.drawImage(mapSprite, 0, 0, 1100, 800);
